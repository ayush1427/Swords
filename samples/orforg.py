...
class orforgDataset(utils.Dataset):

    def load_orforg(self, dataset_dir, subset):
        """Load a subset of the orforg dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have two classes to add.
        self.add_class("orforg", 1, "original")
        self.add_class("orforg", 2, "copied")
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = orforgDataset()
    dataset_train.load_orforg(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = orforgDataset()
    dataset_val.load_orforg(args.dataset, "val")
    dataset_val.prepare()
